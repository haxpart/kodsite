...
const IDler = {
  botID: "757896159262933083",
  botToken: "NzU3ODk2MTU5MjYyOTMzMDgz.X2nDzQ.L1hCDCDidiDeVQvcKus0Cqu2Qt4",
  botSecret: "PfHIxipvt7Ew7QoQ2_AGwf1P9YzdjJro",
  botCallbackURL: "http://tr.bugrakodsitesi.tk/callback",
  callbackurl: "http://tr.bugrakodsitesi.tk/callback",
  sunucuID: "715635168878133329",
  sunucuDavet: "https://discord.gg/Wpz8P9h",
  kodLogKanalı: "756246690901655623",
  sahipRolü: "744911045151162499",
  adminRolü: "744911045780439141",
  kodPaylaşımcıRolü: "756248113571692657",
  boosterRolü: "755896859779661995",
  kodPaylaşamayacakRoller: ["756248930035040327"],
  hazırAltyapılarRolü: "755896859779661995",
  hazırSistemlerRolü: "755896859779661995",
  elmasKodlarRolü: "756248266290757762",
  altınKodlarRolü: "756248385648066720",
  normalKodlarRolü: "744911054802518017"
};
const app = express();
...
app.post("/paylasim", (req, res) => {
  ...
  client.channels.cache.get(IDler.kodLogKanalı).send(
    ...
    .addField("Kod Sayfası", `[Tıkla!](https://rulercode.glitch.me/${obj.kod_rank}/${obj.id})`));
